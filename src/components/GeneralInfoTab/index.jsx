      ...
      <form>
        <div className="content-holder">
          ...
          <div className="box">
            ...
            <p>This unique code is generated at the time you create the emissary and cannot be changed. Your client can use this unique code to direct to your emissary homepage (without the need of URL).</p>
            <div className="code-input">
              <button className="btn-copy"><LuFiles size="20" /></button>
              <input type="text" placeholder="32sj34" />
            </div>
          </div>
          <div className="box">
            <strong className="subtitle">Utilize Asset(s)</strong>
            <p>Add asset(s) that will be using in this emissary for transfer requests and safes payout.</p>
